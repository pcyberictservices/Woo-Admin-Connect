      ...
      >
        <div className="bg-card/60 backdrop-blur-2xl border border-border/50 rounded-2xl shadow-2xl p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-accent shadow-xl shadow-primary/25 mb-4">
              <Store className="h-8 w-8 text-white" />
            </div>
            <h1 className="text-2xl font-bold text-white tracking-tight">Amabelle Foods</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-background/50 border-border/60 h-11 focus-visible:ring-primary/40"
                disabled={isLoading}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="bg-background/50 border-border/60 h-11 pr-11 focus-visible:ring-primary/40"
                  disabled={isLoading}
                />
                <button
                  type="button"
